...
pkgdatadir = $(datadir)/apertium-ewo-fra
pkgincludedir = $(includedir)/apertium-ewo-fra
pkglibdir = $(libdir)/apertium-ewo-fra
pkglibexecdir = $(libexecdir)/apertium-ewo-fra
...
am__installdirs = "$(DESTDIR)$(apertium_ewo_fradir)"
DATA = $(apertium_ewo_fra_DATA) $(noinst_DATA)
...
ACLOCAL = ${SHELL} '/Users/emmanuelngueum/Documents/apertium/apertium-ewo-fra/missing' aclocal-1.17
AMTAR = $${TAR-tar}
...
APERTIUM_LEX_TOOLS_LIBS = 
APERTIUM_LIBS = -L/usr/local/lib -lapertium
AP_LIB1 = ../apertium-ewo
AP_LIB2 = ../apertium-fra
AP_SRC1 = ../apertium-ewo
AP_SRC2 = ../apertium-fra
AP_SUBDIRS =  ../apertium-ewo ../apertium-fra
AUTOCONF = ${SHELL} '/Users/emmanuelngueum/Documents/apertium/apertium-ewo-fra/missing' autoconf
AUTOHEADER = ${SHELL} '/Users/emmanuelngueum/Documents/apertium/apertium-ewo-fra/missing' autoheader
AUTOMAKE = ${SHELL} '/Users/emmanuelngueum/Documents/apertium/apertium-ewo-fra/missing' automake-1.17
AWK = gawk
...
CTAGS = ctags
CYGPATH_W = echo
DEFS = -DPACKAGE_NAME=\"Apertium\ Ewondo-French\" -DPACKAGE_TARNAME=\"apertium-ewo-fra\" -DPACKAGE_VERSION=\"0.1.0\" -DPACKAGE_STRING=\"Apertium\ Ewondo-French\ 0.1.0\" -DPACKAGE_BUGREPORT=\"ngueum@gmail.com\" -DPACKAGE_URL=\"http://wiki.apertium.org/wiki/Apertium-ewo-fra\" -DPACKAGE=\"apertium-ewo-fra\" -DVERSION=\"0.1.0\"
ECHO_C = \c
ECHO_N = 
ECHO_T = 
ETAGS = etags
...
MAKEINFO = ${SHELL} '/Users/emmanuelngueum/Documents/apertium/apertium-ewo-fra/missing' makeinfo
MKDIR_P = mkdir -p
PACKAGE = apertium-ewo-fra
PACKAGE_BUGREPORT = ngueum@gmail.com
PACKAGE_NAME = Apertium Ewondo-French
PACKAGE_STRING = Apertium Ewondo-French 0.1.0
PACKAGE_TARNAME = apertium-ewo-fra
PACKAGE_URL = http://wiki.apertium.org/wiki/Apertium-ewo-fra
...
VERSION = 0.1.0
ZCAT = /usr/bin/gzcat
abs_builddir = /Users/emmanuelngueum/Documents/apertium/apertium-ewo-fra
abs_srcdir = /Users/emmanuelngueum/Documents/apertium/apertium-ewo-fra
abs_top_builddir = /Users/emmanuelngueum/Documents/apertium/apertium-ewo-fra
abs_top_srcdir = /Users/emmanuelngueum/Documents/apertium/apertium-ewo-fra
am__leading_dot = .
am__rm_f_notfound = 
...
install_sh = ${SHELL} /Users/emmanuelngueum/Documents/apertium/apertium-ewo-fra/install-sh
...
###############################################################################
###############################################################################
apertium_ewo_fradir = $(prefix)/share/apertium/$(BASENAME)/

# Files which should be installed to $(prefix)/share/apertium/$(BASENAME)/:
apertium_ewo_fra_DATA = \
	$(TARGETS_COMMON)				\
	$(BASENAME).$(PREFIX1).t1x			\
	$(BASENAME).$(PREFIX1).t2x			\
	$(BASENAME).$(PREFIX1).t3x			\
...
$(am__aclocal_m4_deps):
install-apertium_ewo_fraDATA: $(apertium_ewo_fra_DATA)
	@$(NORMAL_INSTALL)
	@list='$(apertium_ewo_fra_DATA)'; test -n "$(apertium_ewo_fradir)" || list=; \
	if test -n "$$list"; then \
	  echo " $(MKDIR_P) '$(DESTDIR)$(apertium_ewo_fradir)'"; \
	  $(MKDIR_P) "$(DESTDIR)$(apertium_ewo_fradir)" || exit 1; \
	fi; \
	for p in $$list; do \
	...
	while read files; do \
	  echo " $(INSTALL_DATA) $$files '$(DESTDIR)$(apertium_ewo_fradir)'"; \
	  $(INSTALL_DATA) $$files "$(DESTDIR)$(apertium_ewo_fradir)" || exit $$?; \
	done

uninstall-apertium_ewo_fraDATA:
	@$(NORMAL_UNINSTALL)
	@list='$(apertium_ewo_fra_DATA)'; test -n "$(apertium_ewo_fradir)" || list=; \
	files=`for p in $$list; do echo $$p; done | sed -e 's|^.*/||'`; \
	dir='$(DESTDIR)$(apertium_ewo_fradir)'; $(am__uninstall_files_from_dir)
tags TAGS:
...
installdirs:
	for dir in "$(DESTDIR)$(apertium_ewo_fradir)"; do \
...
install-data-am: install-apertium_ewo_fraDATA install-data-local
...
uninstall-am: uninstall-apertium_ewo_fraDATA
...
.PHONY: all all-am am--refresh check check-am clean clean-generic \
	...
	info-am install install-am install-apertium_ewo_fraDATA \
...
$(PREFIX1).automorf.hfst : .deps/$(LANG1).automorf.hfst .deps/$(PREFIX1).autobil.prefixes
	...
	hfst-fst2fst -w .deps/$(PREFIX1).automorf.trimmed -o $@
...
test: all
	echo "house" | apertium -d . ewo-fra | tee .test-mt
	@echo "house" > .test-ref
	@diff .test-ref .test-mt
	echo "house" | apertium -d . fra-ewo | tee .test-mt
	@echo "house" > .test-ref
	@diff .test-ref .test-mt
	@rm .test-ref .test-mt
